    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pgtl_id', models.CharField(blank=True, max_length=150, null=True)),
                ('phone', models.CharField(max_length=100)),
                ('email', models.EmailField(max_length=254)),
                ('address', models.TextField()),
                ('PGTL_photo', models.ImageField(blank=True, null=True, upload_to='PGTL_photo')),
                ('PGTL_birth_certificate', models.FileField(blank=True, null=True, upload_to='PGTL_birth_certificate')),
                ('joining_date', models.DateField(blank=True, null=True)),
                ('PGTL_salary', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_person_phone', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateField(default=django.utils.timezone.now)),
                ('pgtl', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='common.pgtldatabase')),
            ],
        ),
    ]
