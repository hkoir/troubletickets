    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_mp', to='generator.mp')),
                ...
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_region', to='generator.region')),
                ('vehicle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='vehicle.addvehicleinfo')),
                ('zone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_zone', to='generator.zone')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pgr_mp', to='generator.mp')),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pgr_region', to='generator.region')),
                ('zone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pgr_zone', to='generator.zone')),
            ],
        ),
        migrations.AddField(
            model_name='eticket',
            name='assigned_to',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ticket_PGR', to='tickets.pgrdatabase'),
        ),
        migrations.AddField(
            model_name='eticket',
            name='team_leader_name',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ticket_PGTL', to='tickets.pgrdatabase'),
        ),
    ]
