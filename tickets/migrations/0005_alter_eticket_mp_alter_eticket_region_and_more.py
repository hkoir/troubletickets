...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0004_alter_eticket_region_alter_eticket_zone'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='eticket',
            name='region',
            field=models.CharField(blank=True, choices=[('all', 'all'), ('Sylhet', 'Sylhet'), ('Rangpur', 'Rangpur')], default=None, max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='eticket',
            name='zone',
            field=models.CharField(blank=True, choices=[('all', 'all'), ('Sylhet', 'Sylhet'), ('Moulovibazar', 'Moulovibazar'), ('Mymensingh', 'Mymensingh'), ('Kisorganj', 'Kisorganj'), ('Tangail', 'Tangail'), ('Rangpur', 'Rangpur'), ('Dinajpur', 'Dinajpur'), ('Bagura', 'Bagura'), ('Rajshahi', 'Rajshahi')], default=None, max_length=100, null=True),
        ),
    ]
