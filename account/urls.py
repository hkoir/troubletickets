...
urlpatterns = [
    path("login/",CustomLoginView.as_view(template_name="account/login.html", form_class=UserLoginForm),name="login",),
   ...
   # path("logout/", auth_views.LogoutView.as_view(next_page="/account/login/"), name="logout"),
    ...
    path('update_profile_picture/<int:user_id>/', views.update_profile_picture, name='update_profile_picture'),
